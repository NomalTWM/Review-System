    ...
    public partial class Form1 : Form
    {
        ...
        private void UpdateDisplay()
        {
            ...
            switch (comboBox1.SelectedIndex)
            {
                ...
                case 1: orderBy = "ReviewDate desc"; break;

                case 2: orderBy = "RestaurantName desc"; break;//add boolean is text

                default: orderBy = "RestaurantName"; break;//add between 2 dates point 2.h.iv
            }
            ...
            using (SqlDataReader reader = command0.ExecuteReader())
            {
                while (reader.Read())
                {
                    ...
                    ReviewDisplay.Text += ($"{reader["ReviewStarRating"]} stars, from {reader["UserName"]} at {reader["ReviewDate"]}, description: {reader["ReviewText"]}\n");
