    ...
    public partial class Form1 : Form
    {
        ...
        private void AddReviewButton_Click(object sender, EventArgs e)
        {
           ...
           // date = tempDate;
            ...
            {
                restaurantNameTextBox.Text = "Invalid Restaurant Name";
            }
            else
            {
        ...
        public void invisSwitch()
        {
            if (AddReviewButton.Visible)
            {
                ...
                restaurantNameTextBox.Visible = false;
            ...
            else
            {
                ...
                restaurantNameTextBox.Visible = true;
        ...
        {
            if(restaurantNameTextBox.Text == "Restaurant Name")
            {
